...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/owen/vsCode/motion_planning/hw_2/src/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/owen/vsCode/motion_planning/hw_2/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/owen/vsCode/motion_planning/hw_2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/owen/vsCode/motion_planning/hw_2/src/rviz_plugins/${idir}'.  ${_report}")
    endif()
