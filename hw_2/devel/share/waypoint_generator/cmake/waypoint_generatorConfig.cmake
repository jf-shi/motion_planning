...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /home/owen/vsCode/motion_planning/hw_2/src/waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /home/owen/vsCode/motion_planning/hw_2/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /home/owen/vsCode/motion_planning/hw_2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/owen/vsCode/motion_planning/hw_2/src/waypoint_generator/${idir}'.  ${_report}")
    endif()
